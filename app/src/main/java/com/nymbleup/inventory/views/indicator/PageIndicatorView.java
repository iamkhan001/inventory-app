...
import com.nymbleup.inventory.views.indicator.animation.type.*;
import com.nymbleup.inventory.views.indicator.draw.controller.DrawController;
...
import com.nymbleup.inventory.views.indicator.draw.data.PositionSavedState;
import com.nymbleup.inventory.views.indicator.draw.data.RtlMode;
import com.nymbleup.inventory.views.indicator.utils.CoordinatesUtils;
import com.nymbleup.inventory.views.indicator.utils.DensityUtils;
import com.nymbleup.inventory.views.indicator.utils.IdUtils;
...
public class PageIndicatorView extends View implements ViewPager.OnPageChangeListener, IndicatorManager.Listener, ViewPager.OnAdapterChangeListener, View.OnTouchListener {
    ...
    /**
     * Fade on idle will make {@link com.nymbleup.inventory.views.indicator.PageIndicatorView} {@link View#INVISIBLE} if {@link ViewPager} is not interacted
     * in time equal to {@link Indicator#idleDuration}. Take care when setting {@link com.nymbleup.inventory.views.indicator.PageIndicatorView} alpha
     * manually if this is true. Alpha is used to manage fading and appearance of {@link com.nymbleup.inventory.views.indicator.PageIndicatorView} and value you provide
     * will be overridden when {@link com.nymbleup.inventory.views.indicator.PageIndicatorView} enters or leaves idle state.
     *
     * @param fadeOnIdle boolean value to hide {@link com.nymbleup.inventory.views.indicator.PageIndicatorView} when {@link ViewPager} is idle
     */
     ...
     * If {@link Indicator#fadeOnIdle} is true, {@link com.nymbleup.inventory.views.indicator.PageIndicatorView} will
