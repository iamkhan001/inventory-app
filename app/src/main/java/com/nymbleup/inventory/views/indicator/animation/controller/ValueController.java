package com.nymbleup.inventory.views.indicator.animation.controller;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

import com.nymbleup.inventory.views.indicator.animation.data.Value;
import com.nymbleup.inventory.views.indicator.animation.type.ColorAnimation;
import com.nymbleup.inventory.views.indicator.animation.type.DropAnimation;
import com.nymbleup.inventory.views.indicator.animation.type.FillAnimation;
import com.nymbleup.inventory.views.indicator.animation.type.ScaleAnimation;
import com.nymbleup.inventory.views.indicator.animation.type.ScaleDownAnimation;
import com.nymbleup.inventory.views.indicator.animation.type.SlideAnimation;
import com.nymbleup.inventory.views.indicator.animation.type.SwapAnimation;
import com.nymbleup.inventory.views.indicator.animation.type.ThinWormAnimation;
import com.nymbleup.inventory.views.indicator.animation.type.WormAnimation;
