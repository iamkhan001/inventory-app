...
class OrderListAdapter(private val context: Context,val onItemClickListener: OnItemClickListener<Orders>):RecyclerView.Adapter<OrderListAdapter.MyViewHolder>() {
    var list = ArrayList<Orders>()

    fun setDeta(list:ArrayList<Orders>){
        this.list = list
